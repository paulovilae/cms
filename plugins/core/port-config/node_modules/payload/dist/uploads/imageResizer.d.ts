 ...
 */
export default function resizeAndTransformImageSizes({ config, dimensions, file, mimeType, req, savedFilename, staticPath, uploadEdits, withMetadata, }: ResizeArgs): Promise<ImageSizesResult>;
export {};
