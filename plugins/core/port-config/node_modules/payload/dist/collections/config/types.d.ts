...
import type { CustomPreviewButtonProps, CustomPublishButtonType, CustomSaveButtonProps, CustomSaveDraftButtonProps } from '../../admin/components/elements/types';
...
import type { Arguments as RefreshArguments, Result as RefreshResult } from '../../auth/operations/refresh';
...
export type CollectionConfig = {
     ...
     */
    db?: Pick<DatabaseAdapter, 'create' | 'deleteMany' | 'deleteOne' | 'find' | 'findOne' | 'updateOne'>;
    /**
